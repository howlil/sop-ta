...
/**
 * Application data controller editor SOP. Mengikat server workbench ke state editor lokal
 * dan autosave tanpa memiliki page/rendering dependency.
 */
