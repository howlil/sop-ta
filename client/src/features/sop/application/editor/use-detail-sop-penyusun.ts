...
import type { SopHeaderAutosaveStatus } from './use-sop-header-autosave'
import type { SopProsedurAutosaveStatus } from './use-sop-prosedur-autosave'
...
/**
 * Application facade untuk editor SOP Penyusun.
 * Page hanya berinteraksi dengan kontrak ini; data, autosave, dan workflow command
 * diorkestrasi di feature layer.
 */
