...
description: Model software work as typed data-flow graphs using shapes, A/E/R channels, cardinality, boundaries, behavior layers, resource scope, and test dependency substitution. Use when designing, implementing, reviewing, or explaining code architecture, services, APIs, workflows, or typed Effect-style programs.
---
